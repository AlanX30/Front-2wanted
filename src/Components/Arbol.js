    ...
    return(
        ...
        <div className='arbol'>
            ...
            <div className='labelRoot-arbol'>
                <span className='badge badge-warning'>Yo = {user}</span>
            </div>
            <span className='badge badge-dark d-block'>Primer Nivel</span>
            ...
            <span className='badge badge-dark d-block'>Segundo Nivel</span>
            <div className='leaves'>
            ...
            <span className='badge badge-dark d-block'>Tercer Nivel</span>
            <div className='leaves'>
            ...
            <span className='badge badge-dark hidden-lable1'>Cuarto Nivel</span>
            <div className='leaves hidden1'>
            ...
            <span className='badge badge-dark hidden-lable2'>Ultimo Nivel</span>
            <div className='leaves hidden2'>
            ...
            <h1 className='n5 hidden2 btn btn-dark ' onClick={()=>setVisible(!visible)}>Nivel 4 ↓</h1>
                <div className={!visible ? 'no' : 'prueba n5 hidden2' }>
                    <div className='fila-menu'>
                        <div className='item-par'>
                                <Link className='item-menu' to={`/persona/${childsId4[0]}`}><img src={circulo4[0]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[1]}`}><img src={circulo4[1]} alt="circle"/> </Link>
                        </div>
                        <div>
                                <Link className='item-menu' to={`/persona/${childsId4[2]}`}><img src={circulo4[2]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[3]}`}><img src={circulo4[3]} alt="circle"/> </Link>
                        </div>
                        </div>
                    <div className='fila-menu'>
                        <div className='item-par'>
                                <Link className='item-menu' to={`/persona/${childsId4[4]}`}><img src={circulo4[4]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[5]}`}><img src={circulo4[5]} alt="circle"/> </Link>
                        </div>
                        <div>
                                <Link className='item-menu' to={`/persona/${childsId4[6]}`}><img src={circulo4[6]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[7]}`}><img src={circulo4[7]} alt="circle"/> </Link>
                        </div>
                        </div>
                    <div className='fila-menu'>
                        <div className='item-par'>
                                <Link className='item-menu' to={`/persona/${childsId4[8]}`}><img src={circulo4[8]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[9]}`}><img src={circulo4[9]} alt="circle"/> </Link>
                        </div>
                        <div>
                                <Link className='item-menu' to={`/persona/${childsId4[10]}`}><img src={circulo4[10]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[11]}`}><img src={circulo4[11]} alt="circle"/> </Link>
                        </div>
                        </div>
                    <div className='fila-menu'>
                        <div className='item-par'>
                                <Link className='item-menu' to={`/persona/${childsId4[12]}`}><img src={circulo4[12]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[13]}`}><img src={circulo4[13]} alt="circle"/> </Link>
                        </div>
                        <div>
                                <Link className='item-menu' to={`/persona/${childsId4[14]}`}><img src={circulo4[14]} alt="circle"/> </Link>
                                <Link className='item-menu' to={`/persona/${childsId4[15]}`}><img src={circulo4[15]} alt="circle"/> </Link>
                        </div>
                    </div>
                </div>
            
            <span className='badge badge-dark hidden-lable1 hidden2'>Ultimo Nivel</span>

            <h1 className='n5 hidden1 btn btn-dark' onClick={()=>setVisible2(!visible2)}>Nivel 5 ↓</h1>
                 <div className={!visible2 ? 'no' : 'prueba n5 hidden1' }>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[0]}`}><img src={circulo5[0]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[1]}`}><img src={circulo5[1]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[2]}`}><img src={circulo5[2]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[3]}`}><img src={circulo5[3]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[4]}`}><img src={circulo5[4]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[5]}`}><img src={circulo5[5]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[6]}`}><img src={circulo5[6]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[7]}`}><img src={circulo5[7]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[8]}`}><img src={circulo5[8]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[9]}`}><img src={circulo5[9]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[10]}`}><img src={circulo5[10]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[11]}`}><img src={circulo5[11]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[12]}`}><img src={circulo5[12]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[13]}`}><img src={circulo5[13]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[14]}`}><img src={circulo5[14]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[15]}`}><img src={circulo5[15]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[16]}`}><img src={circulo5[16]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[17]}`}><img src={circulo5[17]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[18]}`}><img src={circulo5[18]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[19]}`}><img src={circulo5[19]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[20]}`}><img src={circulo5[20]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[21]}`}><img src={circulo5[21]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[22]}`}><img src={circulo5[22]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[23]}`}><img src={circulo5[23]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[24]}`}><img src={circulo5[24]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[25]}`}><img src={circulo5[25]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[26]}`}><img src={circulo5[26]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[27]}`}><img src={circulo5[27]} alt="circle"/> </Link>
                   </div>
                </div>
               <div className='fila-menu'>
                   <div className='item-par'>
                        <Link className='item-menu' to={`/persona/${childsId5[28]}`}><img src={circulo5[28]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[29]}`}><img src={circulo5[29]} alt="circle"/> </Link>
                   </div>
                   <div>
                        <Link className='item-menu' to={`/persona/${childsId5[30]}`}><img src={circulo5[30]} alt="circle"/> </Link>
                        <Link className='item-menu' to={`/persona/${childsId5[31]}`}><img src={circulo5[31]} alt="circle"/> </Link>
                   </div>
                </div>
